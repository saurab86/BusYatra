...
import 'package:busyatra/helpers/utils.dart';
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              color: ticketModel.amount == 0 ? Colors.grey.withOpacity(0.5) : BusColors.MAIN_PINK,
                              child: Icon(
                      ...
                      ClipOval(
                        child: Material(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              padding: EdgeInsets.all(10),
                              color: ticketModel.amount == tService.maxTickets ? Colors.grey.withOpacity(0.5) : BusColors.MAIN_PINK,
                              child: Icon(
